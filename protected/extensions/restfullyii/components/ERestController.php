...
class ERestController extends Controller
{
 ...
 /**
	...
	public function doRestList()
  {
    ...
    $this->renderJson($this->getModel()->with($this->nestedRelations)->filter($this->restFilter)->orderBy($this->restSort)->limit($this->restLimit)->offset($this->restOffset)->findAll());
